        ...
        <Grid item xs={12} sm={10} md={8} lg={6}>
          <Paper>
            <CardContent className={classes.content}>
              ...
              <Typography variant='body1' component='p' paragraph>Anthony Colangelo is a space enthusiast, podcaster, blogger and developer from Philadelphia, Pennsylvania. He hosts the Main Engine Cut Off Podcast and co-hosts Off-Nominal with Jake.</Typography>
              <img src='https://pbs.twimg.com/profile_images/1199552790541946880/8amz5UPa_400x400.jpg' className={classes.profile}/>
              <TwitterFollowButton screenName='JakeOnOrbit' options={{size: 'large', showCount: false}}/>
              <Typography variant='body1' component='p' paragraph>Jake Robins is a space enthusiast, podcaster and web developer from Vancouver, British Columbia. He hosts the WeMartians Podcast and co-hosts Off-Nominal with Anthony.</Typography>
            </CardContent>
          </Paper>
        </Grid>
      </Grid>
